...
class TestDividing_a_category_of_numbers(unittest.TestCase):
	...
	def test_that_categorize_numbers_return_divisible_not_found_when_divisibles_equals_to_zero(self):
		self.assertRaises(ValueError, Dividing_a_category_of_numbers.categorize_numbers, ([10, 15, 30]), divisor = 0)